...
const Pag = ({ src, text, head, no }) => {
	return (
		<div className="bg-[#81105b] rounded-2xl text-white p-24 sticky top-0 h-screen container">
			<div className="flex justify-between w-full">
				<div className="py-20 w-2/4">
					<div className="relative">
						{/* bg-[#e9ded9] e97be2 b916af ac47a5 ec9fe7 510f4d 791672*/}
						<img
							src={src}
							alt="Why-Iconic-Impact"
							className="w-[100%] p-6 bg-[#e9ded9] h-auto rounded-3xl"
						/>
						<div className="rounded-[100%] px-10 py-7 text-7xl -top-10 -left-16 bg-[#81105b] absolute">{no}</div>
					</div>
